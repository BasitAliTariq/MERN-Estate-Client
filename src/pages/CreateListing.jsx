          ...
          <div className="flex flex-wrap gap-6">
            <div className="flex items-center gap-2">
              <input
                ...
                max="10"
                required
                className="p-3 bg-white border-gray-300 rounded-lg"
                onChange={handleChange}
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="p-3 text-green-700 border border-green-700 rounded uppercase bg-white hover:shadow-lg disabled:opacity-80 cursor-pointer"
            >
